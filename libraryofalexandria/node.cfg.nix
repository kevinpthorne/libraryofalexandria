...
let 
    ...
    clusterOverridesPre = mergeConfig platformOverridesPre (importIfExists ./clusters/${clusterLabel}/default.cfg.nix true);
    nodeTypeOverridesPre = mergeConfig clusterOverridesPre (importIfExists ./clusters/${clusterLabel}/${nodeType}.cfg.nix true);
    ...
    clusterOverrides = mergeConfig platformOverrides (importIfExists ./clusters/${clusterLabel}/default.cfg.nix false);
    nodeTypeOverrides = mergeConfig clusterOverrides (importIfExists ./clusters/${clusterLabel}/${nodeType}.cfg.nix false);
